	...
	<header id="header" class="header">
		<div class="container">
			...
			<nav>
				...
				<ul>
					<li><a href="list"> <i class="fas fa-users fa-2x"></i> <span>MEMBER</span>
					</a></li>
					<li><a href="../feed/list"> <i
							class="fas fa-camera-retro fa-2x"></i> <span>FEED</span>
					</a></li>
					<li><a href="../community/notice/list"> <i
			...
			<main id="main" class="main">
				...
				<section>
					...
					<form class="search__form search__container">
						<div>
							<div>
								사나움<input style="margin-left: 0x;" type="checkbox"> 낯가림<input
									type="checkbox"> 활발<input type="checkbox"> 산만<input
									type="checkbox"> 온순<input type="checkbox"> 착함<input
									type="checkbox">
							</div>
							<div>
								<label>중성화 여부</label> O<input type="checkbox" name="neut"
									value="1"> X<input type="checkbox" name="neut"
									value="0">
							</div>

							<div>
								<label>견종</label> <select class="selectbox">
									<option>견종</option>
									<option>푸들</option>
									<option>비숑</option>
									<option>말티즈</option>
